...
function refilter() {
    ...
    toDisplay.sort(function(itemA, itemB) { //comparator function
        ...
        const severityA = ['UNKNOWN','INFORMATIONAL','LOW', 'MODERATE', 'HIGH'].indexOf(itemA.severity);
        const severityB = ['UNKNOWN','INFORMATIONAL','LOW', 'MODERATE', 'HIGH'].indexOf(itemB.severity);
